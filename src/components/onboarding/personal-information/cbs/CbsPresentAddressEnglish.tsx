...
import { getCBSDivision, postCBSDistrict, postCBSUnion, postCBSUpazila } from '@config/urls.config'
import { useAPIWithToken } from '@hooks/useAPI'
import { ICBSDistrictRes, ICBSDivisionRes, ICBSUnionOrWardRes, ICBSUpazilaRes } from '@interfaces/onboarding.interface'
...
export default function CbsPresentAddressEnglish({ onSubmit, addressError, isLoading }: IPresentAddressEnglish) {
  ...
  const { execute: getDivisionData } = useAPIWithToken<ICBSDivisionRes>()
  const { execute: getDistrictData } = useAPIWithToken<ICBSDistrictRes>()
  const { execute: getUpazilaData } = useAPIWithToken<ICBSUpazilaRes>()
  const { execute: getUnionOrWardData } = useAPIWithToken<ICBSUnionOrWardRes>()
