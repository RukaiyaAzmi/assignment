  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center gap-4 mt-12 animate__animated animate__fadeIn">
        <h4 className="text-2xl mb-4 font-semibold capitalize">Provide Customer Signature</h4>
        <div className="mx-4 flex flex-col gap-4 w-2/3 lg:flex-row lg:w-1/3">
          <ImageUploader
            url={
              applicantFile.signature ? imageConverter(applicantFile.signature) : '/img/placeholder_signature@2x.png'
            }
            name="signature"
        ...
        <div className="w-1/3">
          <Button id="button" label="Capture signature" onClick={handleShowDetailsModal} />
        </div>
      </div>
